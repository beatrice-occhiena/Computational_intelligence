"""
    ...
    This file contains the original code for the Quixo game, already provided in the course repository.
    It is intended to be used as a base for the Final Project.
    - Class Game: contains the game logic
    - Class Player: contains the abstract class for the players
    - Class Move: contains the possible moves
"""
